...
public class StudentController {
	...
	public String listStudents(Model model) {
		model.addAttribute("students",studentService.getAllStudents());//key,value
		return "students";
...
@GetMapping("/students/new")
	...
	@PostMapping("/students") //directly bind form data we use modelattribute annotation
	...
	@GetMapping("/students/edit/{id}")//model used to return some view type, bind this id to some java variable we use pathvariable annotaion
